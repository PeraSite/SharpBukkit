...
namespace SharpBukkit.Network.Utils {
	public static class Defaults {
		public static readonly WorldBiome[] Biomes = {
			new WorldBiome {
				Id = 0,
			...
			new WorldBiome {
				...
				ReplaceMusic = 0,
				MaxDelay = 24000,
				MusicSound = "minecraft:music.overworld.meadow"
			},
			new WorldBiome {
				Id = 29,
				...
				ReplaceMusic = 0,
				MaxDelay = 24000,
				MusicSound = "minecraft:music.overworld.grove"
			},
			new WorldBiome {
				Id = 30,
				...
				ReplaceMusic = 0,
				MaxDelay = 24000,
				MusicSound = "minecraft:music.overworld.snowy_slopes",
				MinDelay = 12000
			},
			new WorldBiome {
				Id = 31,
				...
				ReplaceMusic = 0,
				MaxDelay = 24000,
				MusicSound = "minecraft:music.overworld.frozen_peaks",
				MinDelay = 12000
			},
			new WorldBiome {
				Id = 32,
			...
			new WorldBiome {
				...
				AddedSound = "minecraft:ambient.nether_wastes.additions",
				TickChance = 0.0111
			},
			new WorldBiome {
				Id = 52,
				...
				AddedSound = "minecraft:ambient.warped_forest.additions",
				TickChance = 0.0111,
			...
			new WorldBiome {
				...
				AddedSound = "minecraft:ambient.crimson_forest.additions",
				TickChance = 0.0111,
			...
			new WorldBiome {
				...
				AddedSound = "minecraft:ambient.soul_sand_valley.additions",
				TickChance = 0.0111,
			...
			new WorldBiome {
				...
				AddedSound = "minecraft:ambient.basalt_deltas.additions",
				TickChance = 0.0111,
		...
		public static WorldCodec[] Realms = {
			...
			new WorldCodec {
				...
				PiglinSafe = 1,
				AmbientLight = 0.10000000149011612f,
		...
		public static readonly string[] WorldNames = {"minecraft:overworld", "minecraft:the_nether", "minecraft:the_end"};

		public static readonly string WorldName = "minecraft:overworld";

		public static readonly Dimension CurrentDim = new Dimension {
			BedWorks = 1,
			CoordinateScale = 1,
			Effects = "minecraft:overworld",
			HasRaids = 1,
